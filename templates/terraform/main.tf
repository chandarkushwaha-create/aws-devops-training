# AWS DevOps Batch 4 - Terraform Infrastructure Template
# Main configuration file for production-ready infrastructure
...
terraform {
  ...
  backend "s3" {
    bucket = "aws-devops-batch4-terraform-state"
